...
class TestHashTable(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        self.ht.insertSC("test_key", "test_value")
    ...
    def test_find(self):
        self.assertEqual(self.ht.size, 0)
        obj = "hello"
        self.ht.insertSC("key1", obj)
        self.assertEqual(obj, self.ht.find("key1"))
        obj = ["this", "is", "a", "list"]
        self.ht.insertSC("key2", obj)
    ...
    def test_capacity(self):
        ...
        for i in range(0, 1000):
            ...
            self.ht.insertSC("key" + str(i), "value")
    ...
    def test_issue2(self):
        self.assertEqual(self.ht.size, 0)
        self.ht.insertSC('A', 5)
        self.assertEqual(self.ht.size, 1)
        self.ht.insertSC('B', 10)
        self.assertEqual(self.ht.size, 2)
        self.ht.insertSC('Ball', 'hello')
